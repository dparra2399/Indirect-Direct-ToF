...
mae = np.load('./data/ntbins_1000_k_4_coding_coscos_monte_1000_exp_14.npz')
...
ax.plot_surface(np.log(pAveSourceList), np.log(pAveAmbientList), mae_idtof, cmap=cm.coolwarm,linewidth=0, antialiased=False)
ax.plot_surface(np.log(pAveSourceList), np.log(pAveAmbientList), mae_itof, cmap=cm.autumn, linewidth=0, antialiased=False)
