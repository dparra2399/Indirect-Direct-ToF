...
file = np.load('data/results/5.22-5.29/ntbins_1000_monte_1000_exp_avgphotons_tmp4.npz', allow_pickle=True)
...
for j in range(len(imaging_schemes)):
    ...
    arr.append(go.Surface(z=mae[j, :, :], x=np.log10(levels_one), y=np.log10(levels_two)))
